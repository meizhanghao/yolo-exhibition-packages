...
if __name__ == '__main__':
    ...
    # result = detector.detect_images('../datasets/train/images/000001.jpg')
    # result[0].show()
    ...
    # detector.init_model('../weights/best.pt')
    results = detector.detect_images([
        # '../datasets/train/images/small_(349).jpg',
        # '../datasets/train/images/small_(347).jpg',
        '../datasets/train/images/middle_(1503).jpg',
    ])
