...
def attempt_download(weights):
    print("调用到./utils/google_utils.py的attempt_download函数，此函数下载预训练模型，但因为已下载，就pass")
    pass
    '''
    ...
    msg = weights + ' missing, try downloading from https://github.com/ultralytics/yolov10/releases/'
    models = ['yolov10s.pt', 'yolov10m.pt', 'yolov10l.pt', 'yolov10x.pt']  # available models
    ...
    if file in models and not os.path.isfile(weights):
        ...
        try:  # GitHub
            url = 'https://github.com/ultralytics/yolov10/releases/download/v2.0/' + file
            ...
            url = 'https://storage.googleapis.com/ultralytics/yolov10/ckpt/' + file
            print('Downloading %s to %s...' % (url, weights))
